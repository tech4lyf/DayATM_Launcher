...
public class DepositFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardDMT=(CardView)rootView.findViewById(R.id.cardDMT);
        cardNewUser=(CardView)rootView.findViewById(R.id.cardNewUser);

        cardDMT.setOnClickListener(new View.OnClickListener() {
            @Override
