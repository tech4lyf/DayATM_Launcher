...
public class PutCashActivity extends AppCompatActivity {
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<PutCashActivity> mActivity;

        public MyHandler(PutCashActivity activity) {
    ...
    class Transfer extends AsyncTask<Void,Void,Void>
    {
        ...
        protected void onPostExecute(Void unused) {
            ...
            try {
                ...
                txnId=jsonObject.getString("trans_id");
            ...
            if(status.equals("true"))
            {
                if(txnStatus.equals("pending")) {
                    Toast.makeText(PutCashActivity.this, "Your money will be transferred shortly!", Toast.LENGTH_SHORT).show();
                    Intent actHome = new Intent(PutCashActivity.this, SuccessActivity.class);
                    actHome.putExtra("txnId",txnId);
                    actHome.putExtra("amt",printAmt);
                    actHome.putExtra("loc",loc);
                    actHome.putExtra("mode","DMT");

                    startActivity(actHome);
                }
                else if(txnStatus.equals("success")) {
                    Toast.makeText(PutCashActivity.this, "Transaction Successful!", Toast.LENGTH_SHORT).show();
                    Intent actHome = new Intent(PutCashActivity.this, SuccessActivity.class);

                    startActivity(actHome);
                }
                else if(txnStatus.equals("failed")) {
                    Toast.makeText(PutCashActivity.this, "Transaction Failed!", Toast.LENGTH_SHORT).show();
                    Toast.makeText(PutCashActivity.this, "Please contact customer care", Toast.LENGTH_LONG).show();
                    Intent actHome = new Intent(PutCashActivity.this, HomeActivity.class);
                    startActivity(actHome);
                }
                else{
                    Toast.makeText(PutCashActivity.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
                    Toast.makeText(PutCashActivity.this, "Please contact customer care", Toast.LENGTH_LONG).show();
                    Intent actHome = new Intent(PutCashActivity.this, HomeActivity.class);
                    startActivity(actHome);
                }
